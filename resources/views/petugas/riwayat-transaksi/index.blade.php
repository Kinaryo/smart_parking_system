...
@section('content')
    ...
    <script>
        ...
        async function printNotaFromHistory(id) {
            // Memeriksa apakah Swal (SweetAlert2) tersedia untuk loading state
            ...
            try {
                // Pastikan route 'nota/{id}' ini bisa diakses oleh role petugas di web.php
        ...
        function printNota(data, settings = {}) {
            ...
            <body>
                ...
                <div class="line"></div>
                <div class="row"><span>No Transaksi</span><span>#${data.id}</span></div>
