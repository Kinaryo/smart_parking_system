...
@push('scripts')
    ...
    <script>
        ...
        // 🔥 FIX realtime lebih stabil
        function listenRealtime() {
            if (typeof window.Echo === 'undefined') {
                console.warn("Echo tidak aktif → fallback polling");
                return;
            }

            window.Echo.channel('parking-channel')
                .listen('.SlotUpdated', (e) => {
                    console.log("Realtime update masuk");
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // fallback polling (lebih cepat dari sebelumnya)
