            ...
            <div class="col-md-12">
                <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                    <div class="card-header bg-white py-3">
                        <h5 class="fw-bold mb-0">Edit Data Petugas</h5>
                    </div>
                        ...
                        <form id="formEditPetugas" action="{{ route('admin.petugas.update', $petugas->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $petugas->name) }}" placeholder="Nama lengkap">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email', $petugas->email) }}" placeholder="email@example.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror"
                                    value="{{ old('no_hp', $petugas->no_hp) }}" placeholder="0812xxxx">
                                @error('no_hp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold">Password Baru <span
                                ...
                                <div class="form-text text-info">
                                    <i class="bi bi-info-circle me-1"></i> Biarkan kosong jika tidak ingin mengubah
                                    password.
                                </div>
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
